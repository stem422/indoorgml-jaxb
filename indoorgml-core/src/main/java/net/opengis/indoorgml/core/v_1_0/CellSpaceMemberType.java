...
/**
 * <p>Java class for CellSpaceMemberType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "CellSpace")
    protected CellSpaceType cellSpace;
     ...
     *     
     */
    public void setCellSpace(CellSpaceType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            CellSpaceType theCellSpace;
            theCellSpace = this.getCellSpace();
            strategy.appendField(locator, this, "cellSpace", buffer, theCellSpace);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CellSpaceMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            CellSpaceType lhsCellSpace;
            lhsCellSpace = this.getCellSpace();
            CellSpaceType rhsCellSpace;
            rhsCellSpace = that.getCellSpace();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cellSpace", lhsCellSpace), LocatorUtils.property(thatLocator, "cellSpace", rhsCellSpace), lhsCellSpace, rhsCellSpace)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            CellSpaceType theCellSpace;
            theCellSpace = this.getCellSpace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cellSpace", theCellSpace), currentHashCode, theCellSpace);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CellSpaceMemberType) {
            ...
            if (this.cellSpace!= null) {
                CellSpaceType sourceCellSpace;
                sourceCellSpace = this.getCellSpace();
                CellSpaceType copyCellSpace = ((CellSpaceType) strategy.copy(LocatorUtils.property(locator, "cellSpace", sourceCellSpace), sourceCellSpace));
