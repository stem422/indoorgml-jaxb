    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TransitionType) {
            ...
            if ((this.connects!= null)&&(!this.connects.isEmpty())) {
                ...
                List<StatePropertyType> copyConnects = ((List<StatePropertyType> ) strategy.copy(LocatorUtils.property(locator, "connects", sourceConnects), sourceConnects));
                copy.connects = null;
            ...
            if (this.duality!= null) {
                ...
                CellSpaceBoundaryPropertyType copyDuality = ((CellSpaceBoundaryPropertyType) strategy.copy(LocatorUtils.property(locator, "duality", sourceDuality), sourceDuality));
