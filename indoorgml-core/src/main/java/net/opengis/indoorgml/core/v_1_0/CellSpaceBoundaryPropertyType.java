    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "CellSpaceBoundary")
    protected CellSpaceBoundaryType cellSpaceBoundary;
     ...
     * @return
     *     possible object is
     *     {@link CellSpaceBoundaryType }
     *     
     */
    public CellSpaceBoundaryType getCellSpaceBoundary() {
     ...
     *     
     */
    public void setCellSpaceBoundary(CellSpaceBoundaryType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CellSpaceBoundaryType theCellSpaceBoundary;
            theCellSpaceBoundary = this.getCellSpaceBoundary();
            strategy.appendField(locator, this, "cellSpaceBoundary", buffer, theCellSpaceBoundary);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CellSpaceBoundaryPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            CellSpaceBoundaryType lhsCellSpaceBoundary;
            lhsCellSpaceBoundary = this.getCellSpaceBoundary();
            CellSpaceBoundaryType rhsCellSpaceBoundary;
            rhsCellSpaceBoundary = that.getCellSpaceBoundary();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cellSpaceBoundary", lhsCellSpaceBoundary), LocatorUtils.property(thatLocator, "cellSpaceBoundary", rhsCellSpaceBoundary), lhsCellSpaceBoundary, rhsCellSpaceBoundary)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CellSpaceBoundaryType theCellSpaceBoundary;
            theCellSpaceBoundary = this.getCellSpaceBoundary();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cellSpaceBoundary", theCellSpaceBoundary), currentHashCode, theCellSpaceBoundary);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CellSpaceBoundaryPropertyType) {
            ...
            if (this.cellSpaceBoundary!= null) {
                CellSpaceBoundaryType sourceCellSpaceBoundary;
                sourceCellSpaceBoundary = this.getCellSpaceBoundary();
                CellSpaceBoundaryType copyCellSpaceBoundary = ((CellSpaceBoundaryType) strategy.copy(LocatorUtils.property(locator, "cellSpaceBoundary", sourceCellSpaceBoundary), sourceCellSpaceBoundary));
