    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LocalNamePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final LocalNamePropertyType that = ((LocalNamePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "localName", lhsLocalName), LocatorUtils.property(thatLocator, "localName", rhsLocalName), lhsLocalName, rhsLocalName)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeType theLocalName;
            theLocalName = this.getLocalName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "localName", theLocalName), currentHashCode, theLocalName);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LocalNamePropertyType) {
            ...
            if (this.localName!= null) {
                ...
                CodeType copyLocalName = ((CodeType) strategy.copy(LocatorUtils.property(locator, "localName", sourceLocalName), sourceLocalName));
