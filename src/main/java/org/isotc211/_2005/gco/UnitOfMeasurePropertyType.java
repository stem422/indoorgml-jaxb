    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected JAXBElement<UnitDefinitionType> unitDefinition;
     ...
     *     
     */
    public JAXBElement<UnitDefinitionType> getUnitDefinition() {
     ...
     *     
     */
    public void setUnitDefinition(JAXBElement<UnitDefinitionType> value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<UnitDefinitionType> theUnitDefinition;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnitOfMeasurePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            JAXBElement<UnitDefinitionType> lhsUnitDefinition;
            lhsUnitDefinition = this.getUnitDefinition();
            JAXBElement<UnitDefinitionType> rhsUnitDefinition;
            rhsUnitDefinition = that.getUnitDefinition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unitDefinition", lhsUnitDefinition), LocatorUtils.property(thatLocator, "unitDefinition", rhsUnitDefinition), lhsUnitDefinition, rhsUnitDefinition)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<UnitDefinitionType> theUnitDefinition;
            theUnitDefinition = this.getUnitDefinition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unitDefinition", theUnitDefinition), currentHashCode, theUnitDefinition);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UnitOfMeasurePropertyType) {
            ...
            if (this.unitDefinition!= null) {
                JAXBElement<UnitDefinitionType> sourceUnitDefinition;
                sourceUnitDefinition = this.getUnitDefinition();
                @SuppressWarnings("unchecked")
                JAXBElement<UnitDefinitionType> copyUnitDefinition = ((JAXBElement<UnitDefinitionType> ) strategy.copy(LocatorUtils.property(locator, "unitDefinition", sourceUnitDefinition), sourceUnitDefinition));
