    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnlimitedIntegerPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final UnlimitedIntegerPropertyType that = ((UnlimitedIntegerPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unlimitedInteger", lhsUnlimitedInteger), LocatorUtils.property(thatLocator, "unlimitedInteger", rhsUnlimitedInteger), lhsUnlimitedInteger, rhsUnlimitedInteger)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            UnlimitedIntegerType theUnlimitedInteger;
            theUnlimitedInteger = this.getUnlimitedInteger();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unlimitedInteger", theUnlimitedInteger), currentHashCode, theUnlimitedInteger);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UnlimitedIntegerPropertyType) {
            ...
            if (this.unlimitedInteger!= null) {
                UnlimitedIntegerType sourceUnlimitedInteger;
                sourceUnlimitedInteger = this.getUnlimitedInteger();
                UnlimitedIntegerType copyUnlimitedInteger = ((UnlimitedIntegerType) strategy.copy(LocatorUtils.property(locator, "unlimitedInteger", sourceUnlimitedInteger), sourceUnlimitedInteger));
