    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ScopedNamePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ScopedNamePropertyType that = ((ScopedNamePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scopedName", lhsScopedName), LocatorUtils.property(thatLocator, "scopedName", rhsScopedName), lhsScopedName, rhsScopedName)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeType theScopedName;
            theScopedName = this.getScopedName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scopedName", theScopedName), currentHashCode, theScopedName);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ScopedNamePropertyType) {
            ...
            if (this.scopedName!= null) {
                ...
                CodeType copyScopedName = ((CodeType) strategy.copy(LocatorUtils.property(locator, "scopedName", sourceScopedName), sourceScopedName));
