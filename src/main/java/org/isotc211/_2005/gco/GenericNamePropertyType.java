    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GenericNamePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final GenericNamePropertyType that = ((GenericNamePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractGenericName", lhsAbstractGenericName), LocatorUtils.property(thatLocator, "abstractGenericName", rhsAbstractGenericName), lhsAbstractGenericName, rhsAbstractGenericName)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<CodeType> theAbstractGenericName;
            theAbstractGenericName = this.getAbstractGenericName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractGenericName", theAbstractGenericName), currentHashCode, theAbstractGenericName);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GenericNamePropertyType) {
            ...
            if (this.abstractGenericName!= null) {
                JAXBElement<CodeType> sourceAbstractGenericName;
                sourceAbstractGenericName = this.getAbstractGenericName();
                @SuppressWarnings("unchecked")
                JAXBElement<CodeType> copyAbstractGenericName = ((JAXBElement<CodeType> ) strategy.copy(LocatorUtils.property(locator, "abstractGenericName", sourceAbstractGenericName), sourceAbstractGenericName));
