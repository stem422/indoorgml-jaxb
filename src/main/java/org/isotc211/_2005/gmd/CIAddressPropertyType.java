    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CIAddressPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CIAddressPropertyType that = ((CIAddressPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciAddress", lhsCIAddress), LocatorUtils.property(thatLocator, "ciAddress", rhsCIAddress), lhsCIAddress, rhsCIAddress)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CIAddressType theCIAddress;
            theCIAddress = this.getCIAddress();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciAddress", theCIAddress), currentHashCode, theCIAddress);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CIAddressPropertyType) {
            ...
            if (this.ciAddress!= null) {
                CIAddressType sourceCIAddress;
                sourceCIAddress = this.getCIAddress();
                CIAddressType copyCIAddress = ((CIAddressType) strategy.copy(LocatorUtils.property(locator, "ciAddress", sourceCIAddress), sourceCIAddress));
