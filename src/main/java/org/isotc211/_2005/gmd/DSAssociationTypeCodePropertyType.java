    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DSAssociationTypeCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DSAssociationTypeCodePropertyType that = ((DSAssociationTypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsAssociationTypeCode", lhsDSAssociationTypeCode), LocatorUtils.property(thatLocator, "dsAssociationTypeCode", rhsDSAssociationTypeCode), lhsDSAssociationTypeCode, rhsDSAssociationTypeCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theDSAssociationTypeCode;
            theDSAssociationTypeCode = this.getDSAssociationTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsAssociationTypeCode", theDSAssociationTypeCode), currentHashCode, theDSAssociationTypeCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DSAssociationTypeCodePropertyType) {
            ...
            if (this.dsAssociationTypeCode!= null) {
                CodeListValueType sourceDSAssociationTypeCode;
                sourceDSAssociationTypeCode = this.getDSAssociationTypeCode();
                CodeListValueType copyDSAssociationTypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "dsAssociationTypeCode", sourceDSAssociationTypeCode), sourceDSAssociationTypeCode));
