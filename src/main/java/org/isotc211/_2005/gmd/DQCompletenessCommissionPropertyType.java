    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DQCompletenessCommissionPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DQCompletenessCommissionPropertyType that = ((DQCompletenessCommissionPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqCompletenessCommission", lhsDQCompletenessCommission), LocatorUtils.property(thatLocator, "dqCompletenessCommission", rhsDQCompletenessCommission), lhsDQCompletenessCommission, rhsDQCompletenessCommission)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DQCompletenessCommissionType theDQCompletenessCommission;
            theDQCompletenessCommission = this.getDQCompletenessCommission();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqCompletenessCommission", theDQCompletenessCommission), currentHashCode, theDQCompletenessCommission);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DQCompletenessCommissionPropertyType) {
            ...
            if (this.dqCompletenessCommission!= null) {
                ...
                DQCompletenessCommissionType copyDQCompletenessCommission = ((DQCompletenessCommissionType) strategy.copy(LocatorUtils.property(locator, "dqCompletenessCommission", sourceDQCompletenessCommission), sourceDQCompletenessCommission));
