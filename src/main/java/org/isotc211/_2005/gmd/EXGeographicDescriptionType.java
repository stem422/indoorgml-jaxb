    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EXGeographicDescriptionType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final EXGeographicDescriptionType that = ((EXGeographicDescriptionType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geographicIdentifier", lhsGeographicIdentifier), LocatorUtils.property(thatLocator, "geographicIdentifier", rhsGeographicIdentifier), lhsGeographicIdentifier, rhsGeographicIdentifier)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            MDIdentifierPropertyType theGeographicIdentifier;
            theGeographicIdentifier = this.getGeographicIdentifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geographicIdentifier", theGeographicIdentifier), currentHashCode, theGeographicIdentifier);
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EXGeographicDescriptionType) {
            ...
            if (this.geographicIdentifier!= null) {
                ...
                MDIdentifierPropertyType copyGeographicIdentifier = ((MDIdentifierPropertyType) strategy.copy(LocatorUtils.property(locator, "geographicIdentifier", sourceGeographicIdentifier), sourceGeographicIdentifier));
