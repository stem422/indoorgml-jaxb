    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DSDataSetPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DSDataSetPropertyType that = ((DSDataSetPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsDataSet", lhsDSDataSet), LocatorUtils.property(thatLocator, "dsDataSet", rhsDSDataSet), lhsDSDataSet, rhsDSDataSet)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DSDataSetType theDSDataSet;
            theDSDataSet = this.getDSDataSet();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsDataSet", theDSDataSet), currentHashCode, theDSDataSet);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DSDataSetPropertyType) {
            ...
            if (this.dsDataSet!= null) {
                ...
                DSDataSetType copyDSDataSet = ((DSDataSetType) strategy.copy(LocatorUtils.property(locator, "dsDataSet", sourceDSDataSet), sourceDSDataSet));
