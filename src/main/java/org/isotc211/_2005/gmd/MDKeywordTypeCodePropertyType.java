    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDKeywordTypeCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDKeywordTypeCodePropertyType that = ((MDKeywordTypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdKeywordTypeCode", lhsMDKeywordTypeCode), LocatorUtils.property(thatLocator, "mdKeywordTypeCode", rhsMDKeywordTypeCode), lhsMDKeywordTypeCode, rhsMDKeywordTypeCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDKeywordTypeCode;
            theMDKeywordTypeCode = this.getMDKeywordTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdKeywordTypeCode", theMDKeywordTypeCode), currentHashCode, theMDKeywordTypeCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDKeywordTypeCodePropertyType) {
            ...
            if (this.mdKeywordTypeCode!= null) {
                CodeListValueType sourceMDKeywordTypeCode;
                sourceMDKeywordTypeCode = this.getMDKeywordTypeCode();
                CodeListValueType copyMDKeywordTypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdKeywordTypeCode", sourceMDKeywordTypeCode), sourceMDKeywordTypeCode));
