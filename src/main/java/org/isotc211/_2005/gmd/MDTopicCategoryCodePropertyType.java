    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDTopicCategoryCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDTopicCategoryCodePropertyType that = ((MDTopicCategoryCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdTopicCategoryCode", lhsMDTopicCategoryCode), LocatorUtils.property(thatLocator, "mdTopicCategoryCode", rhsMDTopicCategoryCode), lhsMDTopicCategoryCode, rhsMDTopicCategoryCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDTopicCategoryCodeType theMDTopicCategoryCode;
            theMDTopicCategoryCode = this.getMDTopicCategoryCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdTopicCategoryCode", theMDTopicCategoryCode), currentHashCode, theMDTopicCategoryCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDTopicCategoryCodePropertyType) {
            ...
            if (this.mdTopicCategoryCode!= null) {
                MDTopicCategoryCodeType sourceMDTopicCategoryCode;
                sourceMDTopicCategoryCode = this.getMDTopicCategoryCode();
                MDTopicCategoryCodeType copyMDTopicCategoryCode = ((MDTopicCategoryCodeType) strategy.copy(LocatorUtils.property(locator, "mdTopicCategoryCode", sourceMDTopicCategoryCode), sourceMDTopicCategoryCode));
