    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CIOnlineResourcePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CIOnlineResourcePropertyType that = ((CIOnlineResourcePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciOnlineResource", lhsCIOnlineResource), LocatorUtils.property(thatLocator, "ciOnlineResource", rhsCIOnlineResource), lhsCIOnlineResource, rhsCIOnlineResource)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CIOnlineResourceType theCIOnlineResource;
            theCIOnlineResource = this.getCIOnlineResource();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciOnlineResource", theCIOnlineResource), currentHashCode, theCIOnlineResource);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CIOnlineResourcePropertyType) {
            ...
            if (this.ciOnlineResource!= null) {
                CIOnlineResourceType sourceCIOnlineResource;
                sourceCIOnlineResource = this.getCIOnlineResource();
                CIOnlineResourceType copyCIOnlineResource = ((CIOnlineResourceType) strategy.copy(LocatorUtils.property(locator, "ciOnlineResource", sourceCIOnlineResource), sourceCIOnlineResource));
