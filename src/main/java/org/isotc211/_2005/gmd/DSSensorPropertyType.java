    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DSSensorPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DSSensorPropertyType that = ((DSSensorPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsSensor", lhsDSSensor), LocatorUtils.property(thatLocator, "dsSensor", rhsDSSensor), lhsDSSensor, rhsDSSensor)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DSSensorType theDSSensor;
            theDSSensor = this.getDSSensor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsSensor", theDSSensor), currentHashCode, theDSSensor);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DSSensorPropertyType) {
            ...
            if (this.dsSensor!= null) {
                DSSensorType sourceDSSensor;
                sourceDSSensor = this.getDSSensor();
                DSSensorType copyDSSensor = ((DSSensorType) strategy.copy(LocatorUtils.property(locator, "dsSensor", sourceDSSensor), sourceDSSensor));
