    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDMaintenanceInformationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDMaintenanceInformationPropertyType that = ((MDMaintenanceInformationPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdMaintenanceInformation", lhsMDMaintenanceInformation), LocatorUtils.property(thatLocator, "mdMaintenanceInformation", rhsMDMaintenanceInformation), lhsMDMaintenanceInformation, rhsMDMaintenanceInformation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDMaintenanceInformationType theMDMaintenanceInformation;
            theMDMaintenanceInformation = this.getMDMaintenanceInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdMaintenanceInformation", theMDMaintenanceInformation), currentHashCode, theMDMaintenanceInformation);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDMaintenanceInformationPropertyType) {
            ...
            if (this.mdMaintenanceInformation!= null) {
                ...
                MDMaintenanceInformationType copyMDMaintenanceInformation = ((MDMaintenanceInformationType) strategy.copy(LocatorUtils.property(locator, "mdMaintenanceInformation", sourceMDMaintenanceInformation), sourceMDMaintenanceInformation));
