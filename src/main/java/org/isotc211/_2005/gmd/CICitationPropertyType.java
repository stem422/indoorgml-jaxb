    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CICitationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CICitationPropertyType) {
            ...
            if (this.ciCitation!= null) {
                CICitationType sourceCICitation;
                sourceCICitation = this.getCICitation();
                CICitationType copyCICitation = ((CICitationType) strategy.copy(LocatorUtils.property(locator, "ciCitation", sourceCICitation), sourceCICitation));
