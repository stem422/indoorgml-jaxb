    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDCoverageContentTypeCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDCoverageContentTypeCodePropertyType that = ((MDCoverageContentTypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdCoverageContentTypeCode", lhsMDCoverageContentTypeCode), LocatorUtils.property(thatLocator, "mdCoverageContentTypeCode", rhsMDCoverageContentTypeCode), lhsMDCoverageContentTypeCode, rhsMDCoverageContentTypeCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDCoverageContentTypeCode;
            theMDCoverageContentTypeCode = this.getMDCoverageContentTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdCoverageContentTypeCode", theMDCoverageContentTypeCode), currentHashCode, theMDCoverageContentTypeCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDCoverageContentTypeCodePropertyType) {
            ...
            if (this.mdCoverageContentTypeCode!= null) {
                CodeListValueType sourceMDCoverageContentTypeCode;
                sourceMDCoverageContentTypeCode = this.getMDCoverageContentTypeCode();
                CodeListValueType copyMDCoverageContentTypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdCoverageContentTypeCode", sourceMDCoverageContentTypeCode), sourceMDCoverageContentTypeCode));
