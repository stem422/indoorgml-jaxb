    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDDimensionNameTypeCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDDimensionNameTypeCodePropertyType that = ((MDDimensionNameTypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDimensionNameTypeCode", lhsMDDimensionNameTypeCode), LocatorUtils.property(thatLocator, "mdDimensionNameTypeCode", rhsMDDimensionNameTypeCode), lhsMDDimensionNameTypeCode, rhsMDDimensionNameTypeCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDDimensionNameTypeCode;
            theMDDimensionNameTypeCode = this.getMDDimensionNameTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDimensionNameTypeCode", theMDDimensionNameTypeCode), currentHashCode, theMDDimensionNameTypeCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDDimensionNameTypeCodePropertyType) {
            ...
            if (this.mdDimensionNameTypeCode!= null) {
                CodeListValueType sourceMDDimensionNameTypeCode;
                sourceMDDimensionNameTypeCode = this.getMDDimensionNameTypeCode();
                CodeListValueType copyMDDimensionNameTypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdDimensionNameTypeCode", sourceMDDimensionNameTypeCode), sourceMDDimensionNameTypeCode));
