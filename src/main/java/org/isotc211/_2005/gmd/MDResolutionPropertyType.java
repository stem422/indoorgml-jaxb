    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDResolutionPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDResolutionPropertyType that = ((MDResolutionPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdResolution", lhsMDResolution), LocatorUtils.property(thatLocator, "mdResolution", rhsMDResolution), lhsMDResolution, rhsMDResolution)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDResolutionType theMDResolution;
            theMDResolution = this.getMDResolution();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdResolution", theMDResolution), currentHashCode, theMDResolution);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDResolutionPropertyType) {
            ...
            if (this.mdResolution!= null) {
                MDResolutionType sourceMDResolution;
                sourceMDResolution = this.getMDResolution();
                MDResolutionType copyMDResolution = ((MDResolutionType) strategy.copy(LocatorUtils.property(locator, "mdResolution", sourceMDResolution), sourceMDResolution));
