    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CIRoleCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CIRoleCodePropertyType that = ((CIRoleCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciRoleCode", lhsCIRoleCode), LocatorUtils.property(thatLocator, "ciRoleCode", rhsCIRoleCode), lhsCIRoleCode, rhsCIRoleCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theCIRoleCode;
            theCIRoleCode = this.getCIRoleCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciRoleCode", theCIRoleCode), currentHashCode, theCIRoleCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CIRoleCodePropertyType) {
            ...
            if (this.ciRoleCode!= null) {
                CodeListValueType sourceCIRoleCode;
                sourceCIRoleCode = this.getCIRoleCode();
                CodeListValueType copyCIRoleCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "ciRoleCode", sourceCIRoleCode), sourceCIRoleCode));
