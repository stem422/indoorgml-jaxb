    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDObligationCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDObligationCodePropertyType that = ((MDObligationCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdObligationCode", lhsMDObligationCode), LocatorUtils.property(thatLocator, "mdObligationCode", rhsMDObligationCode), lhsMDObligationCode, rhsMDObligationCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDObligationCodeType theMDObligationCode;
            theMDObligationCode = this.getMDObligationCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdObligationCode", theMDObligationCode), currentHashCode, theMDObligationCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDObligationCodePropertyType) {
            ...
            if (this.mdObligationCode!= null) {
                MDObligationCodeType sourceMDObligationCode;
                sourceMDObligationCode = this.getMDObligationCode();
                MDObligationCodeType copyMDObligationCode = ((MDObligationCodeType) strategy.copy(LocatorUtils.property(locator, "mdObligationCode", sourceMDObligationCode), sourceMDObligationCode));
