    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CITelephonePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CITelephonePropertyType that = ((CITelephonePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciTelephone", lhsCITelephone), LocatorUtils.property(thatLocator, "ciTelephone", rhsCITelephone), lhsCITelephone, rhsCITelephone)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CITelephoneType theCITelephone;
            theCITelephone = this.getCITelephone();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciTelephone", theCITelephone), currentHashCode, theCITelephone);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CITelephonePropertyType) {
            ...
            if (this.ciTelephone!= null) {
                CITelephoneType sourceCITelephone;
                sourceCITelephone = this.getCITelephone();
                CITelephoneType copyCITelephone = ((CITelephoneType) strategy.copy(LocatorUtils.property(locator, "ciTelephone", sourceCITelephone), sourceCITelephone));
