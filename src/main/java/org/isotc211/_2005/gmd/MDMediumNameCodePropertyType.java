    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDMediumNameCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDMediumNameCodePropertyType that = ((MDMediumNameCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdMediumNameCode", lhsMDMediumNameCode), LocatorUtils.property(thatLocator, "mdMediumNameCode", rhsMDMediumNameCode), lhsMDMediumNameCode, rhsMDMediumNameCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDMediumNameCode;
            theMDMediumNameCode = this.getMDMediumNameCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdMediumNameCode", theMDMediumNameCode), currentHashCode, theMDMediumNameCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDMediumNameCodePropertyType) {
            ...
            if (this.mdMediumNameCode!= null) {
                CodeListValueType sourceMDMediumNameCode;
                sourceMDMediumNameCode = this.getMDMediumNameCode();
                CodeListValueType copyMDMediumNameCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdMediumNameCode", sourceMDMediumNameCode), sourceMDMediumNameCode));
