    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CIDateTypeCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CIDateTypeCodePropertyType that = ((CIDateTypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciDateTypeCode", lhsCIDateTypeCode), LocatorUtils.property(thatLocator, "ciDateTypeCode", rhsCIDateTypeCode), lhsCIDateTypeCode, rhsCIDateTypeCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theCIDateTypeCode;
            theCIDateTypeCode = this.getCIDateTypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciDateTypeCode", theCIDateTypeCode), currentHashCode, theCIDateTypeCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CIDateTypeCodePropertyType) {
            ...
            if (this.ciDateTypeCode!= null) {
                CodeListValueType sourceCIDateTypeCode;
                sourceCIDateTypeCode = this.getCIDateTypeCode();
                CodeListValueType copyCIDateTypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "ciDateTypeCode", sourceCIDateTypeCode), sourceCIDateTypeCode));
