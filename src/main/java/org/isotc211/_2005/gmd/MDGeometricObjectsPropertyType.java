    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDGeometricObjectsPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDGeometricObjectsPropertyType that = ((MDGeometricObjectsPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdGeometricObjects", lhsMDGeometricObjects), LocatorUtils.property(thatLocator, "mdGeometricObjects", rhsMDGeometricObjects), lhsMDGeometricObjects, rhsMDGeometricObjects)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDGeometricObjectsType theMDGeometricObjects;
            theMDGeometricObjects = this.getMDGeometricObjects();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdGeometricObjects", theMDGeometricObjects), currentHashCode, theMDGeometricObjects);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDGeometricObjectsPropertyType) {
            ...
            if (this.mdGeometricObjects!= null) {
                MDGeometricObjectsType sourceMDGeometricObjects;
                sourceMDGeometricObjects = this.getMDGeometricObjects();
                MDGeometricObjectsType copyMDGeometricObjects = ((MDGeometricObjectsType) strategy.copy(LocatorUtils.property(locator, "mdGeometricObjects", sourceMDGeometricObjects), sourceMDGeometricObjects));
