    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LILineagePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final LILineagePropertyType that = ((LILineagePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liLineage", lhsLILineage), LocatorUtils.property(thatLocator, "liLineage", rhsLILineage), lhsLILineage, rhsLILineage)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            LILineageType theLILineage;
            theLILineage = this.getLILineage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liLineage", theLILineage), currentHashCode, theLILineage);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LILineagePropertyType) {
            ...
            if (this.liLineage!= null) {
                LILineageType sourceLILineage;
                sourceLILineage = this.getLILineage();
                LILineageType copyLILineage = ((LILineageType) strategy.copy(LocatorUtils.property(locator, "liLineage", sourceLILineage), sourceLILineage));
