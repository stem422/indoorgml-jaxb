    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDPixelOrientationCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDPixelOrientationCodePropertyType that = ((MDPixelOrientationCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdPixelOrientationCode", lhsMDPixelOrientationCode), LocatorUtils.property(thatLocator, "mdPixelOrientationCode", rhsMDPixelOrientationCode), lhsMDPixelOrientationCode, rhsMDPixelOrientationCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDPixelOrientationCodeType theMDPixelOrientationCode;
            theMDPixelOrientationCode = this.getMDPixelOrientationCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdPixelOrientationCode", theMDPixelOrientationCode), currentHashCode, theMDPixelOrientationCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDPixelOrientationCodePropertyType) {
            ...
            if (this.mdPixelOrientationCode!= null) {
                MDPixelOrientationCodeType sourceMDPixelOrientationCode;
                sourceMDPixelOrientationCode = this.getMDPixelOrientationCode();
                MDPixelOrientationCodeType copyMDPixelOrientationCode = ((MDPixelOrientationCodeType) strategy.copy(LocatorUtils.property(locator, "mdPixelOrientationCode", sourceMDPixelOrientationCode), sourceMDPixelOrientationCode));
