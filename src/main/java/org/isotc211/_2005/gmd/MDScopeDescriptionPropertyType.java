    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDScopeDescriptionPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDScopeDescriptionPropertyType that = ((MDScopeDescriptionPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdScopeDescription", lhsMDScopeDescription), LocatorUtils.property(thatLocator, "mdScopeDescription", rhsMDScopeDescription), lhsMDScopeDescription, rhsMDScopeDescription)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDScopeDescriptionType theMDScopeDescription;
            theMDScopeDescription = this.getMDScopeDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdScopeDescription", theMDScopeDescription), currentHashCode, theMDScopeDescription);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDScopeDescriptionPropertyType) {
            ...
            if (this.mdScopeDescription!= null) {
                MDScopeDescriptionType sourceMDScopeDescription;
                sourceMDScopeDescription = this.getMDScopeDescription();
                MDScopeDescriptionType copyMDScopeDescription = ((MDScopeDescriptionType) strategy.copy(LocatorUtils.property(locator, "mdScopeDescription", sourceMDScopeDescription), sourceMDScopeDescription));
