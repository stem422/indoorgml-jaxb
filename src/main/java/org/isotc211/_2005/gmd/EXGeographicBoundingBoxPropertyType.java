    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EXGeographicBoundingBoxPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final EXGeographicBoundingBoxPropertyType that = ((EXGeographicBoundingBoxPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exGeographicBoundingBox", lhsEXGeographicBoundingBox), LocatorUtils.property(thatLocator, "exGeographicBoundingBox", rhsEXGeographicBoundingBox), lhsEXGeographicBoundingBox, rhsEXGeographicBoundingBox)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            EXGeographicBoundingBoxType theEXGeographicBoundingBox;
            theEXGeographicBoundingBox = this.getEXGeographicBoundingBox();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exGeographicBoundingBox", theEXGeographicBoundingBox), currentHashCode, theEXGeographicBoundingBox);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EXGeographicBoundingBoxPropertyType) {
            ...
            if (this.exGeographicBoundingBox!= null) {
                ...
                EXGeographicBoundingBoxType copyEXGeographicBoundingBox = ((EXGeographicBoundingBoxType) strategy.copy(LocatorUtils.property(locator, "exGeographicBoundingBox", sourceEXGeographicBoundingBox), sourceEXGeographicBoundingBox));
