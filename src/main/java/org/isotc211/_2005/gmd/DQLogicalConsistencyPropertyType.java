    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DQLogicalConsistencyPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DQLogicalConsistencyPropertyType that = ((DQLogicalConsistencyPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQLogicalConsistency", lhsAbstractDQLogicalConsistency), LocatorUtils.property(thatLocator, "abstractDQLogicalConsistency", rhsAbstractDQLogicalConsistency), lhsAbstractDQLogicalConsistency, rhsAbstractDQLogicalConsistency)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDQLogicalConsistencyType> theAbstractDQLogicalConsistency;
            theAbstractDQLogicalConsistency = this.getAbstractDQLogicalConsistency();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQLogicalConsistency", theAbstractDQLogicalConsistency), currentHashCode, theAbstractDQLogicalConsistency);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DQLogicalConsistencyPropertyType) {
            ...
            if (this.abstractDQLogicalConsistency!= null) {
                ...
                JAXBElement<? extends AbstractDQLogicalConsistencyType> copyAbstractDQLogicalConsistency = ((JAXBElement<? extends AbstractDQLogicalConsistencyType> ) strategy.copy(LocatorUtils.property(locator, "abstractDQLogicalConsistency", sourceAbstractDQLogicalConsistency), sourceAbstractDQLogicalConsistency));
