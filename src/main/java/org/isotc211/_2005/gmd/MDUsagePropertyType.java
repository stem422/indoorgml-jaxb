    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDUsagePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDUsagePropertyType that = ((MDUsagePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdUsage", lhsMDUsage), LocatorUtils.property(thatLocator, "mdUsage", rhsMDUsage), lhsMDUsage, rhsMDUsage)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDUsageType theMDUsage;
            theMDUsage = this.getMDUsage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdUsage", theMDUsage), currentHashCode, theMDUsage);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDUsagePropertyType) {
            ...
            if (this.mdUsage!= null) {
                MDUsageType sourceMDUsage;
                sourceMDUsage = this.getMDUsage();
                MDUsageType copyMDUsage = ((MDUsageType) strategy.copy(LocatorUtils.property(locator, "mdUsage", sourceMDUsage), sourceMDUsage));
