    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DQScopePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DQScopePropertyType that = ((DQScopePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqScope", lhsDQScope), LocatorUtils.property(thatLocator, "dqScope", rhsDQScope), lhsDQScope, rhsDQScope)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DQScopeType theDQScope;
            theDQScope = this.getDQScope();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqScope", theDQScope), currentHashCode, theDQScope);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DQScopePropertyType) {
            ...
            if (this.dqScope!= null) {
                DQScopeType sourceDQScope;
                sourceDQScope = this.getDQScope();
                DQScopeType copyDQScope = ((DQScopeType) strategy.copy(LocatorUtils.property(locator, "dqScope", sourceDQScope), sourceDQScope));
