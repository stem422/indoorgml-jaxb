    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LISourcePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final LISourcePropertyType that = ((LISourcePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liSource", lhsLISource), LocatorUtils.property(thatLocator, "liSource", rhsLISource), lhsLISource, rhsLISource)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            LISourceType theLISource;
            theLISource = this.getLISource();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liSource", theLISource), currentHashCode, theLISource);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LISourcePropertyType) {
            ...
            if (this.liSource!= null) {
                LISourceType sourceLISource;
                sourceLISource = this.getLISource();
                LISourceType copyLISource = ((LISourceType) strategy.copy(LocatorUtils.property(locator, "liSource", sourceLISource), sourceLISource));
