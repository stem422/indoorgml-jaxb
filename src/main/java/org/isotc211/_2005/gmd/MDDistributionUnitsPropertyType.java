    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDDistributionUnitsPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDDistributionUnitsPropertyType that = ((MDDistributionUnitsPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDistributionUnits", lhsMDDistributionUnits), LocatorUtils.property(thatLocator, "mdDistributionUnits", rhsMDDistributionUnits), lhsMDDistributionUnits, rhsMDDistributionUnits)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDDistributionUnits;
            theMDDistributionUnits = this.getMDDistributionUnits();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDistributionUnits", theMDDistributionUnits), currentHashCode, theMDDistributionUnits);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDDistributionUnitsPropertyType) {
            ...
            if (this.mdDistributionUnits!= null) {
                CodeListValueType sourceMDDistributionUnits;
                sourceMDDistributionUnits = this.getMDDistributionUnits();
                CodeListValueType copyMDDistributionUnits = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdDistributionUnits", sourceMDDistributionUnits), sourceMDDistributionUnits));
