    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDPortrayalCatalogueReferencePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDPortrayalCatalogueReferencePropertyType that = ((MDPortrayalCatalogueReferencePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdPortrayalCatalogueReference", lhsMDPortrayalCatalogueReference), LocatorUtils.property(thatLocator, "mdPortrayalCatalogueReference", rhsMDPortrayalCatalogueReference), lhsMDPortrayalCatalogueReference, rhsMDPortrayalCatalogueReference)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MDPortrayalCatalogueReferenceType theMDPortrayalCatalogueReference;
            theMDPortrayalCatalogueReference = this.getMDPortrayalCatalogueReference();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdPortrayalCatalogueReference", theMDPortrayalCatalogueReference), currentHashCode, theMDPortrayalCatalogueReference);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDPortrayalCatalogueReferencePropertyType) {
            ...
            if (this.mdPortrayalCatalogueReference!= null) {
                ...
                MDPortrayalCatalogueReferenceType copyMDPortrayalCatalogueReference = ((MDPortrayalCatalogueReferenceType) strategy.copy(LocatorUtils.property(locator, "mdPortrayalCatalogueReference", sourceMDPortrayalCatalogueReference), sourceMDPortrayalCatalogueReference));
