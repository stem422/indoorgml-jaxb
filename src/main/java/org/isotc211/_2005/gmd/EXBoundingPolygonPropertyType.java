    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EXBoundingPolygonPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final EXBoundingPolygonPropertyType that = ((EXBoundingPolygonPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exBoundingPolygon", lhsEXBoundingPolygon), LocatorUtils.property(thatLocator, "exBoundingPolygon", rhsEXBoundingPolygon), lhsEXBoundingPolygon, rhsEXBoundingPolygon)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            EXBoundingPolygonType theEXBoundingPolygon;
            theEXBoundingPolygon = this.getEXBoundingPolygon();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exBoundingPolygon", theEXBoundingPolygon), currentHashCode, theEXBoundingPolygon);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EXBoundingPolygonPropertyType) {
            ...
            if (this.exBoundingPolygon!= null) {
                EXBoundingPolygonType sourceEXBoundingPolygon;
                sourceEXBoundingPolygon = this.getEXBoundingPolygon();
                EXBoundingPolygonType copyEXBoundingPolygon = ((EXBoundingPolygonType) strategy.copy(LocatorUtils.property(locator, "exBoundingPolygon", sourceEXBoundingPolygon), sourceEXBoundingPolygon));
