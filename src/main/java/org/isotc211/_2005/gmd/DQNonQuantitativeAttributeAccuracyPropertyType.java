    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DQNonQuantitativeAttributeAccuracyPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DQNonQuantitativeAttributeAccuracyType theDQNonQuantitativeAttributeAccuracy;
            theDQNonQuantitativeAttributeAccuracy = this.getDQNonQuantitativeAttributeAccuracy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqNonQuantitativeAttributeAccuracy", theDQNonQuantitativeAttributeAccuracy), currentHashCode, theDQNonQuantitativeAttributeAccuracy);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DQNonQuantitativeAttributeAccuracyPropertyType) {
            ...
            if (this.dqNonQuantitativeAttributeAccuracy!= null) {
                ...
                DQNonQuantitativeAttributeAccuracyType copyDQNonQuantitativeAttributeAccuracy = ((DQNonQuantitativeAttributeAccuracyType) strategy.copy(LocatorUtils.property(locator, "dqNonQuantitativeAttributeAccuracy", sourceDQNonQuantitativeAttributeAccuracy), sourceDQNonQuantitativeAttributeAccuracy));
