    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDCellGeometryCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDCellGeometryCodePropertyType that = ((MDCellGeometryCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdCellGeometryCode", lhsMDCellGeometryCode), LocatorUtils.property(thatLocator, "mdCellGeometryCode", rhsMDCellGeometryCode), lhsMDCellGeometryCode, rhsMDCellGeometryCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDCellGeometryCode;
            theMDCellGeometryCode = this.getMDCellGeometryCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdCellGeometryCode", theMDCellGeometryCode), currentHashCode, theMDCellGeometryCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDCellGeometryCodePropertyType) {
            ...
            if (this.mdCellGeometryCode!= null) {
                CodeListValueType sourceMDCellGeometryCode;
                sourceMDCellGeometryCode = this.getMDCellGeometryCode();
                CodeListValueType copyMDCellGeometryCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdCellGeometryCode", sourceMDCellGeometryCode), sourceMDCellGeometryCode));
