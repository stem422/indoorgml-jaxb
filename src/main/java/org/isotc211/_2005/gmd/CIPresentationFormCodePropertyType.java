    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CIPresentationFormCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CIPresentationFormCodePropertyType that = ((CIPresentationFormCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciPresentationFormCode", lhsCIPresentationFormCode), LocatorUtils.property(thatLocator, "ciPresentationFormCode", rhsCIPresentationFormCode), lhsCIPresentationFormCode, rhsCIPresentationFormCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theCIPresentationFormCode;
            theCIPresentationFormCode = this.getCIPresentationFormCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciPresentationFormCode", theCIPresentationFormCode), currentHashCode, theCIPresentationFormCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CIPresentationFormCodePropertyType) {
            ...
            if (this.ciPresentationFormCode!= null) {
                CodeListValueType sourceCIPresentationFormCode;
                sourceCIPresentationFormCode = this.getCIPresentationFormCode();
                CodeListValueType copyCIPresentationFormCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "ciPresentationFormCode", sourceCIPresentationFormCode), sourceCIPresentationFormCode));
