    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MDClassificationCodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MDClassificationCodePropertyType that = ((MDClassificationCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdClassificationCode", lhsMDClassificationCode), LocatorUtils.property(thatLocator, "mdClassificationCode", rhsMDClassificationCode), lhsMDClassificationCode, rhsMDClassificationCode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDClassificationCode;
            theMDClassificationCode = this.getMDClassificationCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdClassificationCode", theMDClassificationCode), currentHashCode, theMDClassificationCode);
        }
        {
            List<String> theNilReason;
            theNilReason = (((this.nilReason!= null)&&(!this.nilReason.isEmpty()))?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MDClassificationCodePropertyType) {
            ...
            if (this.mdClassificationCode!= null) {
                CodeListValueType sourceMDClassificationCode;
                sourceMDClassificationCode = this.getMDClassificationCode();
                CodeListValueType copyMDClassificationCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdClassificationCode", sourceMDClassificationCode), sourceMDClassificationCode));
