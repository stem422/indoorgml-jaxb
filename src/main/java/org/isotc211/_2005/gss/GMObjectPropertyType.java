    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GMObjectPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GMObjectPropertyType) {
            ...
            if (this.abstractGeometry!= null) {
                ...
                JAXBElement<?> copyAbstractGeometry = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractGeometry", sourceAbstractGeometry), sourceAbstractGeometry));
