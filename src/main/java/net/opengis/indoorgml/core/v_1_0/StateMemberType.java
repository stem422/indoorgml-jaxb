...
/**
 * <p>Java class for StateMemberType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StateMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof StateMemberType) {
            ...
            if (this.state!= null) {
                ...
                StateType copyState = ((StateType) strategy.copy(LocatorUtils.property(locator, "state", sourceState), sourceState));
